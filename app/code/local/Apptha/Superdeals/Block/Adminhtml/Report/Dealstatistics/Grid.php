 ...
 */     
 ...
 protected function _prepareMassaction() {
  ...
  $this->getMassactionBlock ()->addItem ( 'delete', array (
    'label' => Mage::helper ( 'superdeals' )->__ ( 'Delete' ),'url' => $this->getUrl ( '*/*/massDelete' ),
 ...
 protected function _prepareColumns() {
  ...
  $this->addColumn ( 'sku', array (
    'header' => $this->__ ( 'SKU' ),'sortable' => true,
    'index' => 'sku' 
  ) );
  $this->addColumn ( 'actual_price', array (
    'header' => $this->__ ( 'Original Price' ),'sortable' => true,'index' => 'actual_price',
    'type' => 'currency','currency_code' => $sym 
  ) );
  $this->addColumn ( 'deal_price', array (
    'header' => $this->__ ( 'Deal Price ' ),
    'sortable' => true,'index' => 'deal_price',
    'type' => 'currency','currency_code' => $sym 
  ) );
  $this->addColumn ( 'quantity', array (
    'header' => $this->__ ( 'Total Quantity Sold' ),
    'sortable' => true,'index' => 'quantity','default' => $this->__ ( '0' ),
    'align' => 'right','type' => 'number','width' => 1 
  ) );
