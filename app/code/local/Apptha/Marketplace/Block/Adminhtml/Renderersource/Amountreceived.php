...
class Apptha_Marketplace_Block_Adminhtml_Renderersource_Amountreceived extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        $collection = Mage::getModel ( 'marketplace/transaction' )->getCollection ()->addFieldToSelect ( 'seller_commission' )->addFieldToFilter ( 'seller_id', $value )->addFieldToFilter ( 'paid', 1 );
