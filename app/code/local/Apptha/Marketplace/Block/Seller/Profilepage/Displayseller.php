...
class Apptha_Marketplace_Block_Seller_Profilepage_Displayseller extends Mage_Core_Block_Template {
 ...
 public function bestSellerCollection($sellerId) {
  ...
  return Mage::getResourceModel ( 'reports/product_collection' )->addOrderedQty ()->addAttributeToSelect ( '*' )->addAttributeToSelect ( array (
    ...
    'small_image',
    'seller_id' 
  ) )->addAttributeToFilter ( 'seller_id', $sellerId )->setStoreId ( $storeId )->addStoreFilter ( $storeId )->addAttributeToFilter ( 'visibility', $visibility )->setOrder ( 'ordered_qty', 'desc' );
 }
 /**
