 ...
 */
class Magehit_Faq_Helper_Wysiwygimages extends Mage_Cms_Helper_Wysiwyg_Images
{
    ...
    public function getImageHtmlDeclaration($filename, $renderAsTag = false)
    {
        ...
        if ($renderAsTag) {
            ...
            if ($this->isUsingStaticUrlsAllowed()) {
                ...
                $html = Mage::helper('adminhtml')->getUrl('*/adminhtml_wysiwyg/directive', array('___directive' => $directive));
            }
        }
        return $html;
    }
